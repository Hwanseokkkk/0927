<%@page import="myboard.service.BoardService"%>
...
<%
	String bdomainParam 
		= request.getParameter("bdomain")==null ? "" : request.getParameter("bdomain");
	String searchDomainParam
		= request.getParameter("searchDomain")==null ? "" : request.getParameter("searchDomain");
	String searchTextParam
		= request.getParameter("searchText")==null ? "" : request.getParameter("searchText");
...
<div>
	<form name="searchForm" action="/MyBoard/jsp/listBoard.jsp">
		<select name="bdomainSelect"
			onchange="location.href='/MyBoard/jsp/listBoard.jsp?bdomain='+this.value;">
